...
<div class="portlet light bordered">
    <form role="form" action="{{ route('dashboard::add') }}" method="POST">
    {{ csrf_field() }}
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="inbox-form-group margin-top-10{{ $errors->has('address') ? ' has-error' : '' }}">
                    ...
                    <textarea name="address" class="form-control spinners" id="" cols="105" rows="10"></textarea>
                </div>
            </div>
        </div>
